...
public class BasicDocument extends Document 
{
	...
	{
		List<String> tokens = getTokens("[a-zA-Z]+");//TODO: Implement this method in week 2 according to the comments above.  
		return tokens.size();// See the Module 2 support videos if you need help.
	...
	public int getNumSentences()
	{
	    ...
	    return tokens.size();//TODO: Implement this method.  See the Module 2 support videos 
        // if you need help.
	...
	{
		int count = 0;
		List<String> tokens = getTokens("[a-zA-Z]+");//TODO: Implement this method in week 2.  See the Module 2 support videos 
