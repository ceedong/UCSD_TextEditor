...
public class WPTree implements WordPath {
	...
	public WPTree () {
		this.root = null;
		Dictionary d = new DictionaryHashSet();// TODO initialize a NearbyWords object
		DictionaryLoader.loadDictionary(d, "data/dict.txt");// Dictionary d = new DictionaryHashSet();
		this.nw = new NearbyWords(d);// DictionaryLoader.loadDictionary(d, "data/dict.txt");
